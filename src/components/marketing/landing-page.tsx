  ...
  return (
    <div className="flex min-h-full flex-1 flex-col bg-white text-neutral-950">
      <header className="border-b border-neutral-200">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-6 sm:h-[4.5rem] sm:px-8">
          <Link href="/" className="text-[15px] leading-none tracking-tight">
            <span className="font-semibold">devWeekend</span>
            <span className="font-normal text-neutral-500"> learning</span>
          </Link>
          <Link
            href="/login"
          ...
          <div className="mt-12">
            <Link
              ...
              className={cn(
                ...
                "h-11 rounded-md bg-neutral-950 px-8 text-sm font-medium text-white hover:bg-neutral-800"
              )}
            >
              Start learning
            </Link>
      ...
      <footer className="border-t border-neutral-200">
        <div className="mx-auto max-w-5xl px-6 py-8 sm:px-8">
          <p className="text-sm text-neutral-500">
            <span className="font-medium text-neutral-950">devWeekend</span> learning
          </p>
        </div>
      </footer>
    </div>
