...
```predict
prompt: "MongoDB is unavailable when FreshMarket starts. Which boot sequence tells the truth?"
options:
  - id: connect-first
    label: "Await the database connection, then start listening"
  - id: listen-first
    label: "Start listening, then connect in the background"
