---
id: multi-vendor-marketplace-02-08
title: "2.8 — Create the repo"
module: 2
lesson: 8
stepType: Build
phase: "Module 2"
...
<BigWordAlert term="Git repository" plainEnglish="Version-controlled project folder where every change is tracked and reversible." whyItMatters="FreshMarket lives in one repo from day one — commits mark chapter milestones you can demo or roll back." />
...
```openquestion
prompt: Paste the GitHub repository URL for your FreshMarket project and briefly confirm that the first commit is pushed and no secrets are tracked.
submissionMode: url_required
allowUrl: true
urlRequired: true
urlLabel: FreshMarket repository
