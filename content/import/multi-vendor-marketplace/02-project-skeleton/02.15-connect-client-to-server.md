---
id: multi-vendor-marketplace-02-15
title: "2.15 — Connect client to server"
module: 2
lesson: 15
stepType: Build
phase: "Module 2"
...
> **[Build]** · Chapter 02 — Project skeleton · *Home page fetches `/health`; display JSON in UI*
...
<BigWordAlert term="Cross-origin request" plainEnglish="An HTTP call from the browser to a different host or port than the page was loaded from." whyItMatters="Connecting client to server is your first real network integration — CORS and env base URLs must align." />
